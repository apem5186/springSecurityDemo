...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .formLogin()
                .loginPage("/login")
                .successHandler(new CustomAuthenticationSuccessHandler(tokenProvider(), userRepository))
                ...
                .addFilterBefore(new JwtAuthenticationFilter(tokenProvider(), userSecurityService, userRepository), UsernamePasswordAuthenticationFilter.class)
